              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="validationCustom01"
                         placeholder="Ex: Add a new Group" name="groupName"
                         value="<?= $this->data['currentGroup']->name ?>"
                  required>
                ...
                <?php if (!empty($this->data['allPrivileges'])): $i=0;
                        foreach ($this->data['allPrivileges'] as $privilege) : ?>
                    <div >
                        <input  type="checkbox" id="privilegeName_<?=$i?>"
                                value="<?=$privilege->id ?>"
                                <?= in_array($privilege->id, $this->data['currentGroupIds']) ? "checked" : "" ?>
                                name="privileges[]">
                        <label style="font-weight: 500;" for="privilegeName_<?=$i++?>" ><?=$privilege->privillege
                          ?></label>
                    </div>
