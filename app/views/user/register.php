    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-danger" role="alert">
                <?php foreach ($this->getErrors() as $err):?>
                <li><?= $err ?></li>
            ...
            <form action="registerValidation" method="post">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Full name" name="name" value="<?php if (isset($_POST['name'])) echo $_POST['name']; ?>">
                ...
                <div class="input-group mb-3">
                    <input type="email" class="form-control"
                           placeholder="Email" name="email" value="<?php if
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control"
                           ...
                           value="<?php if (isset($_POST['rePassword'])) echo
                           $_POST['rePassword']; ?>">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
